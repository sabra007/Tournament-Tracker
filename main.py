...
def slotSelectionValidation(participant_dict):
    desired_slot = input(f"Desired starting slot #[1-{len(participant_dict)}]: ")
    while 1:
...
def signUp(participants_dict):
    ...
    while 1:
        ...
        desired_slot = slotSelectionValidation(participants_dict)
